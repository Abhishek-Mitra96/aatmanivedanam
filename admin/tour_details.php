...
$obj=new stdClass();
$obj->tour_id=$id;
$result=tourDetails($obj);
$arr=json_decode($result);

// print_r($arr);

?>
<script > console.log(<?php echo $result; ?>);</script>
      ...
      <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="form-horizontal">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <img alt="" class="main-image" id="img_set1" src="<? echo $arr->tour[0]->img1;?>">
                      ...
                      <div class="col-md-5">
                            ...
                            <h3 id="category"><strong>Category: </strong> <? echo $arr->tour[0]->category_name;?></h3>
       
                        
                            <h3 id="brand"><strong>Brand: </strong> <? echo $arr->tour[0]->brand_name;?></h3>
