...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1> Audios
    <a href="audio_add.php" class="btn btn-info pull-right" role="button">Add Audio</a>
  </section>
...
function search(){
    var searchkey = $('#search').val();
       ...
       var page=$(".active1").attr("page");
        ...
        $.ajax({
            type: 'POST',
            url: '../adminapi/audio/audio_list.php',
            data: {
                search:searchkey,
                status:status,
                page:page,
  ...
  if(arr.status=="success"){
    ...
    if(audio_count!=0){
      ...
      for(i=0;i<audio_count;i++){
        ...
        out+='<td>';
        if(arr.audio_list[i].category_status=="1")
          out+='<a href="audio_category_detail.php?id='+arr.audio_list[i].category_id+'" class="text-success">'+arr.audio_list[i].category_name+'</a>';
        else out+='<a href="audio_category_detail.php?id='+arr.audio_list[i].category_id+'" class="text-danger">'+arr.audio_list[i].category_name+'</a>';
        out+='</td>';
