...
<div class="content-wrapper">
    ...
    <div class="box box-primary">
        ...
        <form name="mastercategory_edit" action="blog_category_edit_2.php" method="POST"  enctype="multipart/form-data">
...
function category_details(){
    var id = <?php echo $_REQUEST["id"]; ?>
        ...
        $.ajax({
            type: 'POST',
            url: '../adminapi/blog_category/blog_category_details.php',
            data: {
                id:id
                },
...
function print_data(fetchdata)
    ...
    for(x=0;x<arr.categories.length;x++)
        {
            $("#cat_id").val(arr.categories[x].blog_cat_id);
