...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1> Images
    <a href="image_add.php" class="btn btn-info pull-right" role="button">Add Images</a>
  </section>
...
function search(){
    var searchkey = $('#search').val();
       ...
       var page=$(".active1").attr("page");
        ...
        $.ajax({
            type: 'POST',
            url: '../adminapi/image/image_list.php',
            data: {
                search:searchkey,
                status:status,
                page:page,
  ...
  if(arr.status=="success"){
    ...
    if(image_count!=0){
      ...
      for(i=0;i<image_count;i++){
        ...
        out+='<td>';
        if(arr.image_list[i].category_status=="1")
          out+='<a href="image_category_detail.php?id='+arr.image_list[i].category_id+'" class="text-success">'+arr.image_list[i].category_name+'</a>';
        else out+='<a href="image_category_detail.php?id='+arr.image_list[i].category_id+'" class="text-danger">'+arr.image_list[i].category_name+'</a>';
        out+='</td>';
